              ...
              <div className="flex items-start gap-3">
                <div className="relative w-10 h-10">
                  <Avatar>
                    ...
                    />
                    <AvatarFallback className="w-10 h-10 rounded-full flex items-center justify-center bg-zinc-700 text-white text-sm font-medium border border-zinc-800">
                      {user.fullName[0]}
                    </AvatarFallback>
                  </Avatar>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {isPlaying ? (
                    <div className="mt-1">
                      ...
                      <div className="text-xs text-zinc-400 truncate">by SonTung MTP</div>
                    </div>
                  ) : (
